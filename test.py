...
def main(args):
    ...
    test_datasets =torchvision.datasets.ImageFolder(root='/mnt/omr/chenhq/CBAM_PyTorch/test',transform=valid_transform)
    test_dataloaders =DataLoader(test_datasets,batch_size=64, shuffle=False,num_workers=32)
    #直接读
    ...
    my_tester = Tester(my_model, args.model, loss_fn, optimizer, lr_schedule, 500, is_use_cuda, test_dataloaders, \
                        metric, args.debug, logger, writer)
    my_tester.fit()
